...
public class SDS_Summon_History extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sds_summon_history);

        back_arrow = findViewById(R.id.back_arrow_sds_history);
        back_arrow.setOnClickListener(this);
        back = findViewById(R.id.back_sds_history);
        back.setOnClickListener(this);
        background_audio3 = MediaPlayer.create(SDS_Summon_History.this, R.raw.sds_summon_theme_audio);
        background_audio3.setLooping(true);
        background_audio3.start();


        mute_button = findViewById(R.id.volume_control3);
        mute_button.setOnClickListener(this);

        if (!SDS_Summon.volume_state) {
    ...
    public static void setLists(ArrayList<Card> list, HashSet<Card> list2) {
        ...
        cardsHash.removeAll(Arrays.asList(SDSBanner.RARE, SDSBanner.SR));
    }
