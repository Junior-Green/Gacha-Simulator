...
public class DBL_Summon_History extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dbl_summon_history);

        back_arrow = findViewById(R.id.back_arrow_dbl_history);
        back_arrow.setOnClickListener(this);
        back = findViewById(R.id.back_dbl_history);
        back.setOnClickListener(this);
        background_audio3 = MediaPlayer.create(DBL_Summon_History.this, R.raw.dbl_summon_theme_audio);
        ...
        if (!cardsHash.isEmpty()) {
            ...
            for (Card c : cardsHash)
                frequencies.add(Integer.toString(Collections.frequency(cards, c) * 600));
        } else
            frequencies = new ArrayList<>();
        ...
        recyclerView = findViewById(R.id.recycler_dbl);
        recyclerView.setLayoutManager(layoutManager);
        DBLRecyclerViewAdapter adapter = new DBLRecyclerViewAdapter(cardsHash, frequencies);
    ...
    public static void setLists(ArrayList<Card> list, HashSet<Card> list2) {
        ...
        cardsHash.removeAll(Arrays.asList(DBLBanner.EX, DBLBanner.HE));
    }

    @Override
    public void onBackPressed() {
        background_audio3.release();
        Intent i = new Intent(DBL_Summon_History.this, Dokkan_Summon.class);
        startActivity(i);
        overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
        state = false;
        finish();
